...
/****** Object:  Database [ShekelTest]    Script Date: 01/01/2023 18:17:23 ******/
CREATE DATABASE [ShekelTest]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'ShekelTest', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\ShekelTest.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'ShekelTest_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\ShekelTest_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [ShekelTest] SET RECOVERY FULL 
GO
